...
- [Guides](#guides)
  - [Recipes](#recipes)
    ...
    - [Publish Autogenerated Mutations with Computed Input Values](#publish-autogenerated-mutations-with-computed-input-values)
    - [Globally Remove a Field from Input Types and Infer its Value](#globally-remove-a-field-from-input-types-and-infer-its-value)
...
type Options = {
   ...
   * The function is passed the context object. Typically a Prisma Client JS instance will
