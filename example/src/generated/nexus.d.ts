...
export interface NexusGenInputs {
  AuthorCreateManyWithoutAuthorsInput: {
    // input type
  ...
  AuthorCreateOneWithoutAuthorInput: {
    // input type
    connect?: NexusGenInputs['AuthorWhereUniqueInput'] | null // AuthorWhereUniqueInput
