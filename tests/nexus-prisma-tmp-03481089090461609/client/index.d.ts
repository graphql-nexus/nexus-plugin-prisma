...
export interface UserDelegate {
  ...
  **/
   ...
   * const userWithCustom_idOnly = await prisma.user.findMany({ select: { custom_id: true } })
   * 
  **/
...
export interface PostDelegate {
  ...
  **/
   ...
   * 
   * // Only select the `custom_id`
   * const postWithCustom_idOnly = await prisma.post.findMany({ select: { custom_id: true } })
   * 
  **/
...
export type FindManyPostArgs = {
  ...
  **/
  ...
  /**
   * Get all Posts that come after or before the Post you provide with the current order.
  **/
  take?: number
  /**
