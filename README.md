...
This plugin has been upgraded to support **Prisma 4.0+**. Latest version of prisma supported: [Prisma 4.16.1](https://github.com/prisma/prisma/releases/tag/4.16.1)
