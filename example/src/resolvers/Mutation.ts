...
export const Mutation = prismaObjectType('Mutation', t => {
  t.field('deletePost', 'Post', {
    ...
    resolve: (parent, args, ctx) => {
      ...
      // "Variable '$where' expected value of type 'PostWhereUniqueInput!' but value is undefined. Reason: Expected non-null value, found null. (line 1, column 11):\nmutation ($where: PostWhereUniqueInput!)
      return t.prismaType.deletePost.resolve(parent, { where: { id: args.id } } as any, ctx)
    }
  })
